# -*- coding: utf-8 -*-
"""Лабораторная работа №2 (задание 2).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1qlHG5eWETOCu18To270sEEYOfFROMqJr
"""
...
y_resh = np.empty(shape=(y.shape[0], 3))
...
outputSize = 1 if not len(y.shape) else y.shape[1] # количество выходных сигналов равно количеству классов задачи
