# -*- coding: utf-8 -*-
"""Лабораторная работа №2 (задание 1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1YG4HnX982joTF-N4HXjGS0diElr0_09Y
"""
...
def backward(learning_rate, target, net_output, layers):
    ...
    for i in range(len(layers)-1, 0, -1):
        ...
        dw = np.dot(layers[i - 1].T, err_delta[0])

        # обновляем веса слоя
        for j in range(0, len(weights[i - 1])):
          weights[i - 1][j] += learning_rate * dw[j]
...
for i in range(iterations):
    ...
    train(X[rand], y[rand], learning_rate)
